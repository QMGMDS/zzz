...
namespace SPCharacter.Core
{
    ...
    public class MotionDriver
    {
        ...
        /// <param name="bodyTransform">角色本体 Transform - 提供朝向并接收根运动位移</param>
        public MotionDriver(
        ...
        /// <summary>
        /// 位移更新。
        /// 须在动画进度回写黑板、旋转更新之后调用，以保证采样所用的归一化时间和角色朝向新鲜。
        /// </summary>
        ...
        private void ApplyDisplacement()
        {
            ...
            _bodyTransform.position += worldDelta;
        }
        ...
        /// <summary>
        /// 旋转更新。
        /// 须由 SPCC 在动画进度回写黑板之后、位移更新之前调用，让本帧根运动位移按新朝向转到世界空间。
        /// </summary>
