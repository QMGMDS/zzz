...
namespace GamePlay.State
{
    ...
    /// </summary>
    public class EvadeBackState : StateBase
    {
        ...
        {
            Context = context;
            Context.Animator.CrossFadeInFixedTime(Common.AnimationHashes.EvadeBack, CrossFadeDuration);
        ...
        public override void Update()
        {
            ...
            if (Time.time - _animEnterTime < Context.EvadeBackCommitDuration)
                return;
